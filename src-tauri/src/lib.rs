...
pub fn run() {
    ...
    let builder = tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            crewing_intake::crewing_intake_candidate_get,
            crewing_intake::crewing_intake_fact_list,
            crewing_intake::crewing_intake_fact_record,
