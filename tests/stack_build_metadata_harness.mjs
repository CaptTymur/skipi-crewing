...
ok(html.includes("component: 'Crewing'"), 'one UI build-metadata input names Crewing');
ok(html.includes("component_version: '0.4.136'"), 'build-metadata input carries component version 0.4.136');
...
ok(html.includes('Skipi Crewing · Stack SKIPI-2026.08-R1'), 'main header exposes the exact Stack label without Settings');
ok(html.includes('data-qa="desktop-stack-label">Skipi Crewing · Stack SKIPI-2026.08-R1</div>'), 'loaded desktop main shell exposes the exact Stack label inline');
...
ok(cargo.includes('version = "0.4.136"'), 'Cargo package version is 0.4.136');
ok(lock.includes('name = "skipi-crewing"\nversion = "0.4.136"'), 'Cargo lock root package version is 0.4.136');
ok(tauri.version === '0.4.136', 'Tauri component version is 0.4.136');
ok(tauri.identifier === 'app.skipi.crewing', 'desktop app identity is preserved');
